...
theme_dir = os.getenv("HOME") .. "/.config/awesome/themes/bounty"

theme = {}
theme.font          = "envy code r 8"

theme.bg_normal     = "#050505"
theme.bg_focus      = "#252f39"
theme.bg_urgent     = "#91231c"
theme.bg_minimize   = "#050505"

theme.fg_normal     = "#ffffff"
theme.fg_focus      = "#ffffff"
theme.fg_urgent     = "#ffe75f"
theme.fg_minimize   = "#aaaaaa"

theme.border_width  = "1"
theme.border_normal = "#000000"
theme.border_focus  = "#425b6f"
theme.border_marked = "#ffe75f"
...
theme.wallpaper_cmd = { "awsetbg -u feh " .. theme_dir .. "/background.jpg" }
...
theme.awesome_icon = theme_dir .. "/icons/awesome32.png"
